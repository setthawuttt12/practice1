                    ...
                    <v-col cols="12">
                        ...
                        <v-table class="table">
                            ...
                            <tr v-for="indicate in topic.indicates" :key="indicate.id_indicate">
                                ...
                                <td class="border pa-1 text-center" style="width: 10%;">{{ scores[indicate.id_indicate]?.a ?? 'รอกรรมการประเมิน' }}</td>
                                <td class="border pa-1 text-center" style="width: 10%;">{{ scores[indicate.id_indicate]?.a ?? 'รอเลขาประเมิน' }}</td>
