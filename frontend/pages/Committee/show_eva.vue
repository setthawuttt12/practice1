                        ...
                        <v-table>
                            ...
                            <tbody>
                                <tr v-for="(items,index) in result" :key="items.id_eva">
                                    ...
                                    <td class="text-center border">รอบการประเมิน {{ items.round_sys }} ปี {{ items.year_sys }}</td>
                                    ...
                                    <td class="text-center border">
                                        <v-btn color="blue" size="small" class="text-white" prepend-icon="mdi-eye" @click="go(items.id_eva)">ตรวจสอบ</v-btn>
                                    </td>
                                </tr>
